...
const UploadPage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    // 1. Upload images to backend and get their paths
    let imagePaths = [];
    if (images.length > 0) {
    ...
    // 2. Prepare product data with images field
    const productData = {
      ...formData,
      images: imagePaths,
    };

    // TODO: Call create product API slice here
    // Example: dispatch(createProduct(productData));
