...
const ShopByCategories = () => {
  const {data : categories=[], isLoading,isError, refetch} = useGetTopCategoriesQuery();
  console.log("top products : ",categories)
  // const categorie = [
  //   {
  //     name: "Men's Fashion",
          ...
          {categories.map((category) => (
            ...
            >
              <div className="aspect-[4/5] relative">
                ...
                />
                <div
                  className={`absolute inset-0 bg-gradient-to-t from-blue-500 to-blue-600 opacity-60 group-hover:opacity-70 transition-opacity`}
                />
