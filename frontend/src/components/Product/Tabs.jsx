...
const Tabs = ({ product }) => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto mt-6">
        ...
        {tabs.map((tab, index) => (
          <button
            ...
            className={`
              ...
              ${
                activeTab === tab
                  ? "bg-white text-green-600 shadow-inner border-b-2 border-green-600"
      ...
      {/* Tab content */}
      <div className="mt-4 bg-white border border-gray-300 rounded-lg p-6 text-gray-800 shadow-sm">
        {/* Specifications */}
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <tbody>
                ...
                <tr className="border-b border-gray-200">
                  <th className="py-2 pr-4 font-medium text-gray-700">Condition</th>
                ...
                <tr className="border-b border-gray-200">
                  <th className="py-2 pr-4 font-medium text-gray-700">In Stock</th>
                  <td className="py-2" colSpan={3}>
                    {product.countInStock}
                  </td>
                </tr>
                <tr className="border-b border-gray-200">
                  <th className="py-2 pr-4 font-medium text-gray-700">Uploaded By</th>
                  <td className="py-2" colSpan={3}>
            ...
            {product.reviews?.length > 0 ? (
              product.reviews.map((r) => (
                <div key={r._id} className="border-b border-gray-200 py-2">
                  <p className="font-semibold text-gray-800">{r.user?.username}</p>
